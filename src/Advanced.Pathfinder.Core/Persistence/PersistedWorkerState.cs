...
namespace Advanced.Pathfinder.Core.Persistence;
...
public record PersistedPathfinderWorkerState(Guid PathfinderId, Direction StartDirection, int SourcePointId, int TargetPointId, TimeSpan Timeout, int FoundPathCounter, DateTime StartTime);